    ...
    public static class RepositoryPrint 
    {
        public  static async Task<List<string>> GetPrinters()
        {
            return await Task.Run(() =>
            {
                ...
                string ConnectionString = Preferences.Get("ConnectionString", @"User ID=sa;Password=1;Pooling=false;Data Source=192.168.1.187\SQLEXPRESS2019;Initial Catalog=SmartLobSidall");
